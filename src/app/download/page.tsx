          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-cyan-300/20 bg-cyan-500/10 p-4">
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-cyan-200">Current plan</p>
                <p className="mt-2 text-lg font-semibold">{entitlements.label}</p>
              </div>
              <div className="rounded-2xl border border-emerald-300/20 bg-emerald-500/10 p-4">
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-200">Driver seats</p>
                <p className="mt-2 text-lg font-semibold">Up to {seatLabel(entitlements.maxDrivers)}</p>
              </div>
              <div className="rounded-2xl border border-violet-300/20 bg-violet-500/10 p-4">
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-violet-200">Dispatcher seats</p>
